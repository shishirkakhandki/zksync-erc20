...
class Wallet extends abstract_wallet_1.AbstractWallet {
    ...
    signSyncTransfer(transfer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ethereumSignature = signer_1.unableToSign(this.ethSigner())
                ? null
    ...
    syncTransfer(transfer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return operations_1.submitSignedTransaction(signedTransferTransaction, this.provider);
        });
    }
    // ChangePubKey part
    ...
    setSigningKey(changePubKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return operations_1.submitSignedTransaction(txData, this.provider);
        });
    }
    // Withdraw part
    ...
    withdrawFromSyncToEthereum(withdraw) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return operations_1.submitSignedTransaction(signedWithdrawTransaction, this.provider, withdraw.fastProcessing);
        });
    }
    // Forced exit part
    ...
    syncForcedExit(forcedExit) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return operations_1.submitSignedTransaction(signedForcedExitTransaction, this.provider);
        });
    }
    // Swap part
    signOrder(orderData) {
    ...
    syncSwap(swap) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return operations_1.submitSignedTransaction(signedSwapTransaction, this.provider);
        });
    }
    // Mint NFT part
    signMintNFT(mintNFT) {
    ...
    mintNFT(mintNFT) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return operations_1.submitSignedTransaction(signedMintNFTTransaction, this.provider, false);
        });
    }
    // Withdraw NFT part
    ...
    withdrawNFT(withdrawNFT) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return operations_1.submitSignedTransaction(signedWithdrawNFTTransaction, this.provider, withdrawNFT.fastProcessing);
        });
    }
    // Transfer NFT part
    ...
    syncMultiTransfer(transfers) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            messages.push(`Nonce: ${batchNonce}`);
            const message = messages.filter((part) => part.length != 0).join('\n');
            const ethSignatures = signer_1.unableToSign(this.ethSigner())
                ? []
