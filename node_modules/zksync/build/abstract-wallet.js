...
class AbstractWallet {
    ...
    getEthereumBalance(token) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield utils_1.getEthereumBalance(this.ethSigner().provider, this.provider, this.cachedAddress, token);
            }
            catch (e) {
    ...
    getToggle2FA(enable, pubKeyHash) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const signature = yield this.ethMessageSigner().getEthMessageSignature(utils_1.getToggle2FAMessage(enable, timestamp, pubKeyHash));
            return {
                accountId,
                signature,
                timestamp,
    ...
    verifyNetworks() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.provider.network != undefined && this.ethSigner().provider != undefined) {
                ...
                if (types_1.l1ChainId(this.provider.network) !== ethNetwork.chainId) {
