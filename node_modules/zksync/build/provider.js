...
function getDefaultProvider(network, transport = 'HTTP', pollIntervalMilliSecs) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (network === 'localhost') {
            ...
            if (transport === 'WS') {
                return yield Provider.newWebsocketProvider('wss://sepolia-api.zksync.io/jsrpc-ws', network);
            }
            else if (transport === 'HTTP') {
                return yield Provider.newHttpProvider('https://sepolia-api.zksync.io/jsrpc', pollIntervalMilliSecs, network);
            }
        }
