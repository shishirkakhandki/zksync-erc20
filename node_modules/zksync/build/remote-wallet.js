...
class RemoteWallet extends abstract_wallet_1.AbstractWallet {
    ...
    syncTransfer(transfer) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return operations_1.submitSignedTransaction(signed, this.provider);
        });
    }
    // ChangePubKey part
    ...
    withdrawFromSyncToEthereum(withdraw) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return operations_1.submitSignedTransaction(signed, this.provider, fastProcessing);
        });
    }
    // Forced exit part
    ...
    syncMultiTransfer(_transfers) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return operations_1.submitSignedTransactionsBatch(this.provider, signed);
        });
    }
    // ****************
    // Internal methods
