...
function getDefaultRestProvider(network, pollIntervalMilliSecs) {
    return __awaiter(this, void 0, void 0, function* () {
        if (network === 'localhost') {
            ...
            return yield RestProvider.newProvider('https://goerli-api.zksync.io/api/v0.2', pollIntervalMilliSecs, network);
        }
        else if (network === 'sepolia') {
            return yield RestProvider.newProvider('https://sepolia-api.zksync.io/api/v0.2', pollIntervalMilliSecs, network);
        }
        else if (network === 'goerli-beta') {
            return yield RestProvider.newProvider('https://goerli-beta-api.zksync.dev/api/v0.2', pollIntervalMilliSecs, network);
        }
